...
- **See exactly how much mail data each account transfers.** Hover an account in the sidebar for today's and this month's totals, or open the new Settings → Data Usage page for daily, weekly, monthly and yearly breakdowns of downloaded and uploaded bytes. Useful for keeping an eye on provider limits — Gmail suspends IMAP access for up to 24 hours past 2,500 MB down / 500 MB up in a day.
