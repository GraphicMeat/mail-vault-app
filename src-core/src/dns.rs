...
// Moved from src-tauri/src/dns.rs (Task 5.8), verbatim, same relocate-then-
// re-export pattern Task 5.3 used for smtp.rs. No `crate::`-relative imports
// to fix — this code never referenced the app crate.
