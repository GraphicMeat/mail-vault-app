...
export const SAMPLE_MESSAGE = () => ({
  ...
  subject: t('util.exportSampleData.brisketSansLicenceRenews4'),
...
export const SAMPLE_THREAD = () => ([
  {
    ...
    subject: t('util.exportSampleData.pressSlotFriday0600'),
...
so anything you want changed has to be with us by 15:00 Thursday.</p><p>Theo</p>`,
  ...
  },
  {
    ...
    subject: t('util.exportSampleData.rePressSlotFriday06'),
