        ...
        {FREE().map((f) => {
          ...
          return (
            <div key={f.id} data-testid={`free-feature-${f.id}`}
                 className="p-3 rounded-lg border border-mail-border bg-mail-surface">
              <div className="w-7 h-7 rounded bg-mail-accent/10 flex items-center justify-center mb-2">
